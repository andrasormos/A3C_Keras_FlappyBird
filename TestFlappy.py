...
model = load_model("saved_models/model_updates5900", custom_objects={'logloss': logloss, 'sumofsquares': sumofsquares})
...
while True:
    if FIRST_FRAME:
        ...
        # if myCount % 10 == 0:
        # 	# SAVE TO CSV
        # 	fileName = "C:/Users/Treebeard/PycharmProjects/A3C_Keras_FlappyBird/spitout/img_" + str(myCount) + "_.csv"
...
evalGamer = pd.DataFrame(columns=['evalScore'])
logCnt = 0

for i in range(1,6):
    model = load_model("saved_models/model_updates6000", custom_objects={'logloss': logloss, 'sumofsquares': sumofsquares})
    score = 0
    counter = 0
    ...
    while counter < 50:
        ...
        if terminal == True:
            print("DIEDEDEDDEEEEEEDDEED", "SCORE:", score)
            logCnt += 1
            evalGamer.loc[logCnt] = score
