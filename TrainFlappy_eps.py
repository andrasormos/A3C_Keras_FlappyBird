...
playLog = pd.DataFrame(columns=['score', 'random', 'predictedChoice'])
logCnt = 0
score = 0
randList = []
randMean = 0
...
# trainLogName = "C:/Users/Treebeard/PycharmProjects/A3C_Keras_FlappyBird/spitout/trainLog.csv"
...
def runprocess(thread_id, s_t):
    ...
    while t - t_start < t_max and terminal == False:
        ...
        if thread_id == 0:
            ...
            playLog.loc[logCnt] = score, randMean, predictedChoice
            logCnt += 1
            if logCnt % 100 == 0:
